 ...
 */
	...
	class ModuleLanguages extends Module
	{
		...
		public static $_moduleName = 'languages';
		...
		public function __construct()
		{
			...
			*/
			...
			|
			*/
			$Smarty->_load(CP_DIR . '/modules/languages/lang/' . $_SESSION['current_language'] . '.ini', 'name');
			...
			*/
			Navigation::add(
				50,
				$Smarty->_get('languages_menu_name'),
				'sli sli-text-translate',
				'languages',
				'languages',
				Navigation::LEFT,
