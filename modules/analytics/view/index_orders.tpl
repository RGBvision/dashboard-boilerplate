<div id="main-holder" class="row edit-layout">
  <div class="col-12">
    <div id="ordersPeriod" class="card">
      ...
      <div class="card-block">
        <div class="card-limit-30">
          <canvas class="chart-js" id="chartPeriod"
                  {if isset($smarty.session.user_settings.analytics.orders.ordersInterval.datatype) and  {$access} and $smarty.session.user_settings.analytics.orders.ordersInterval.datatype == 1}
                    data-suffix=""
                  {else}
                    data-suffix="%"
                  {/if}
                  {if isset($smarty.session.user_settings.analytics.orders.ordersInterval.viewtype) and $smarty.session.user_settings.analytics.orders.ordersInterval.viewtype == 1}
      ...
      <div class="card-block">
        <div class="card-limit-30">
          <canvas class="chart-js" id="chartYear"
                  {if isset($smarty.session.user_settings.analytics.orders.ordersYear.datatype) and  {$access} and $smarty.session.user_settings.analytics.orders.ordersYear.datatype == 1}
                    data-suffix=""
                  {else}
                    data-suffix="%"
                  {/if}
                  {if isset($smarty.session.user_settings.analytics.orders.ordersYear.viewtype) and $smarty.session.user_settings.analytics.orders.ordersYear.viewtype == 1}
                    data-chart-type="radar"
                  {else}
                    data-chart-type="line"
                  {/if}
      ...
      <div class="card-block">
        <div class="card-limit-30">
          <canvas class="chart-js" id="chartDaily"
                  {if isset($smarty.session.user_settings.analytics.orders.averageDaily.datatype) and  {$access} and $smarty.session.user_settings.analytics.orders.averageDaily.datatype == 1}
                    data-suffix=""
                  {else}
                    data-suffix="%"
                  {/if}
                  {if isset($smarty.session.user_settings.analytics.orders.averageDaily.viewtype) and $smarty.session.user_settings.analytics.orders.averageDaily.viewtype == 1}
                    data-chart-type="radar"
                  {else}
                    data-chart-type="line"
                  {/if}
      ...
      <div class="card-block">
        <div class="card-limit-30">
          <canvas class="chart-js" id="chartHourly"
                  {if isset($smarty.session.user_settings.analytics.orders.averageHourly.datatype) and {$access} and $smarty.session.user_settings.analytics.orders.averageHourly.datatype == 1}
                    data-suffix=""
                  {else}
                    data-suffix="%"
                  {/if}
                  {if isset($smarty.session.user_settings.analytics.orders.averageHourly.viewtype) and $smarty.session.user_settings.analytics.orders.averageHourly.viewtype == 1}
                    data-chart-type="radar"
                  {else}
                    data-chart-type="line"
                  {/if}
