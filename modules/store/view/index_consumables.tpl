  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-block">
        <table id="storeConsumablesControlTable" class="table table-striped dt-responsive nowrap" data-order="[[0,&quot;asc&quot;]]">
          <thead>
          <tr>
            <th class="text-center">{#store_table_name#}</th>
            <th class="text-center">{#store_table_department#}</th>
            ...
            <th class="text-center">{#store_table_sum#}</th>
          ...
          {foreach from=$store item=good key=key}
            <tr>
              <td>
                <a href="./index.php?route=store/edit&type=consumable&good_id={$good.good_id}">{$good.name}</a>
              </td>
              <td class="text-center">
                {$departments[$good.department]}
              </td>
              <td class="text-right">
              ...
              <td class="text-right">
                {$good.sum|number_format:2:".":"'"}
              </td>
              <td class="text-center">
                <a class="btn btn-xs btn-primary" title="{#button_edit#}" data-toggle="tooltip" data-placement="top" href="./index.php?route=store/edit&type=consumable&good_id={$good.good_id}">
      ...
      {if isset($smarty.session.permissions.store_edit) or isset($smarty.session.permissions.all_permissions)}
        <div class="card-footer text-right">
          {if $smarty.const.ORGACTIVE}
            <a href="/index.php?route=store/add&type=consumable" class="btn btn-primary btn-icon">
