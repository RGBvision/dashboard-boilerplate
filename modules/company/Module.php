 ...
 */
	...
	class ModuleCompany extends Module
	{
		...
		public static $_moduleName = 'company';
		...
		public function __construct()
		{
			...
			|
			*/
			$_permissions = array('company_view', 'company_edit');
			Permission::add('company', $_permissions, 'sli-settings-cog-lightbulb', 70);
			...
			*/
			Navigation::add(
				1,
				$Smarty->_get('company_menu_name'),
				'sli sli-settings-cog-lightbulb',
                'company',
				self::$_moduleName,
				Navigation::LEFT,
