	...
	class ControllerLogs extends Controller
	{
		...
		public static function index()
		{
			...
			$data = array (
				...
				'page' => 'logs',
				//-- Title
				'page_title' => $Smarty->_get('logs_page_title'),
				//-- Header
				'header' => $Smarty->_get('logs_page_header'),
				//-- Breadcrumbs
				'breadcrumbs' => array (
					array (
					...
					array(
						'text'      => $Smarty->_get('logs_breadcrumb'),
						'href'      => '',
						'page'      => '',
						'push'      => '',
						'active'    => true
			...
			$Smarty
				->assign('data', $data)
				->assign('right_header', $Smarty->fetch('modules/logs/view/right.tpl'))
				->assign('content', $Smarty->fetch('modules/logs/view/index.tpl'));
		}
	}