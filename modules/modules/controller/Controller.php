	...
	class ControllerModules extends Controller
	{
		...
		public static function index()
		{
			...
			$data = array (
				...
				'page' => 'modules',
				//-- Title
				'page_title' => $Smarty->_get('modules_page_title'),
				//-- Header
				'header' => $Smarty->_get('modules_page_header'),
				//-- Breadcrumbs
				'breadcrumbs' => array (
					array (
					...
					array(
						'text'      => $Smarty->_get('modules_breadcrumbs'),
						'href'      => '',
						'page'      => '',
						'push'      => '',
						'active'    => true
			...
			$classes = self::$model->get();

			$Smarty
				->assign('data', $data)
				->assign('classes', $classes)
				->assign('right_header', $Smarty->fetch('modules/modules/view/right.tpl'))
				->assign('content', $Smarty->fetch('modules/modules/view/index.tpl'));
		}
	}